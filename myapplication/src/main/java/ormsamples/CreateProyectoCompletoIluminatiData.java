...
public class CreateProyectoCompletoIluminatiData {
	public void createTestData() throws PersistentException {
		...
		try {
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : factura, reclama, abonado_a, DNI
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : genera, utilizado_por, ID, nServicio
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : estado, reclamada_por
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : es_parte, ID, nCanal
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : corresponde_a, cliente
